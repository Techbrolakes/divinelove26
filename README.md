...
<img src="apps/marketing/public/logo/monogram-white-on-blue.jpeg" alt="Divine Love 26 monogram" width="140" />
...
**The Invitation** — landing hero with the save-the-date countdown.

![Hero — Save the Date](docs/screenshots/hero.jpg)

**Our Story** — drop-cap prose with polaroid photography over the royal-navy backdrop.

![Our Story](docs/screenshots/our-story.jpg)

**The Gallery** — polaroid grid with captioned tiles and a full-screen lightbox.

![The Gallery](docs/screenshots/gallery.jpg)
